...
#include "/opt/anaconda3/pkgs/pytorch-1.7.1-py3.7_0/lib/python3.7/site-packages/torch/include/script.h"
#include <torch/torch.h>
//#include <torch/Tensor.h>
#include "/Users/peng/libtorch/include/ATen/Tensor.h"
...
int main(int argc, const char* argv[]) {
  ...
  module.forward(std::move(inputs)).toTensor();
